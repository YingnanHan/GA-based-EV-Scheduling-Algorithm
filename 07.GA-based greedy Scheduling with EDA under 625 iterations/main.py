...
class GeneticAlgorithm: # 定义遗传算法类
    ...
    def __init__(self,t_c_l,ev_ct,ev_cp,n,c_rate=0.7,m_rate=0.3,pop_size=200,maxnum=625): # 初始化遗传算法执行下来所需要的所有变量
    ...
    def solve(self): # EV问题的解决方案
        ...
        print("self.fitness:上",self.fitness)
        ...
        plt.plot(range(0,200),list(self.trace[:,0]),linewidth = '1',color= '#800080',label="GA-based greedy Scheduling with EDA")
